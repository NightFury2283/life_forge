...
func NewLogger(logConfig LoggerConfig) (*Logger, error) {
	...
	if err := os.MkdirAll(logConfig.Folder, 0755); err != nil {
	...
	//для ссылки на код в IDE
	zapConfig.EncodeCaller = func(caller zapcore.EntryCaller, enc zapcore.PrimitiveArrayEncoder) {
